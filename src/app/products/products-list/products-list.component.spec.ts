...
import { DOMHelper } from 'src/app/testing/dom-helper.testing';
...
describe('ProductsListComponent', () => {
  ...
  beforeEach(() => {
    productServiceMock = jasmine.createSpyObj('ProductFacadeService', [
      'getProducts',
      'deleteProduct',
    ]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: ProductFacadeService, useValue: productServiceMock },
      ],
    }).compileComponents();
  });
  ...
  describe('List Products', () => {
    ...
    it('Should show 5 product names and ids in spans', () => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        expect(dh.countText('span', product.name + ' -- ' + product.id)).toBe(
          1
        );
      }
    });
  ...
  describe('Delete Products', () => {
    ...
    xit('Should call deleteProduct from facade once when we click Delete button', () => {
      component.products = helper.getProducts(1);
      fixture.detectChanges();
      spyOn(component, 'deleteProduct');
      dh.clickButton('Delete');
      expect(component.deleteProduct).toHaveBeenCalledTimes(1);
      expect(productServiceMock.deleteProduct).toHaveBeenCalledWith('abc0');
    });
